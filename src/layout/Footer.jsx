...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <Stethoscope className="absolute top-24 left-[5%] w-24 h-24 text-white/[0.02] pointer-events-none z-0" />
      <Heart className="absolute top-1/2 right-[8%] w-20 h-20 text-white/[0.02] pointer-events-none z-0 animate-pulse" />
      <Shield className="absolute bottom-24 left-[12%] w-20 h-20 text-white/[0.02] pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-8 relative z-10">
          ...
          {[
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 text-[10px] md:text-xs mt-0.5">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
          ...
          <div className="footer-grid-column space-y-5 text-left">
            ...
            <div className="bg-white/[0.04] border border-white/[0.08] backdrop-blur-md rounded-2xl p-4 text-[10px] text-slate-400 leading-normal space-y-1 select-none">
              <p className="font-extrabold text-white">{BRAND_CONFIG.name} Legal Compliance</p>
          ...
          <div className="footer-grid-column space-y-4 text-left">
            ...
            <div className="pt-2">
              <p className="text-[11px] font-bold text-slate-300 mb-2">Subscribe to Insurance Insights</p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2.5 mb-10 border-b border-white/10 pb-10">
          {[
        ...
        <div className="pt-2 flex flex-col lg:flex-row items-center justify-between gap-6 text-[11px] text-slate-400 relative z-20">
