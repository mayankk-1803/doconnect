  ...
  return (
    <section className="py-[60px] md:py-[90px] lg:py-[100px] bg-[#F8FBFD] relative border-b border-[#DCEAF4]">
      <div className="max-w-3xl mx-auto px-6">
            ...
            return (
              <div
                ...
                className={`border rounded-2xl transition-all duration-300 bg-white ${
                  isOpen ? 'border-[#2F6FAF] shadow-sm shadow-[#2F6FAF]/5' : 'border-[#DCEAF4] hover:border-[#2F6FAF]/40'
                }`}
              >
                <button
                ...
                >
                  <span className={`font-bold text-sm leading-snug transition-colors ${
                    isOpen ? 'text-[#2F6FAF]' : 'text-[#16324F] group-hover:text-[#2F6FAF]'
                  }`}>
                    {faq.question}
                  </span>
                ...
                >
                   <div className="px-6 pb-5 pt-1 text-[#64798D] text-xs md:text-sm leading-relaxed border-t border-[#DCEAF4]/50">
                    {faq.answer}
                  </div>
                </div>
              </div>
        ...
        {/* Support Link */}
        <div className="text-center mt-10 pt-8 border-t border-[#DCEAF4] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#64798D] text-xs font-bold text-left">
            Still have questions? Connect with our senior advisors directly.
          </p>
          <Link
            to="/contact"
            className="inline-flex items-center gap-1.5 bg-[#2F6FAF] hover:bg-[#245B91] text-white font-bold text-xs px-5 py-3 rounded-xl transition shadow-md shadow-[#2F6FAF]/15 hover:shadow-lg active:scale-[0.98] cursor-pointer"
          >
            Contact Advisor
