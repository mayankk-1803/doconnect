...
const HERO_CATEGORIES = [
  ...
  { id: 'health', title1: 'Health', title2: 'Insurance', badge: 'Upto 25% Off*', badgeColor: 'bg-[#075FC1]', path: '/health-insurance' },
  { id: 'term', title1: 'Term', title2: 'Insurance', badge: 'Save On Tax*', badgeColor: 'bg-[#075FC1]', path: 'https://wa.me/917683098648?text=Hello%20DoConnect%2C%20I%20am%20interested%20in%20a%20Term%20Insurance%20plan.' },
...
const Hero = () => {
    ...
    switch (catId) {
      case 'car':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Windshield */}
            <path d="M15.5 25L18.5 15.5C18.9 14.2 20.1 13.5 21.5 13.5H26.5C27.9 13.5 29.1 14.2 29.5 15.5L32.5 25H15.5Z" fill="#1296DB" />
            {/* Body */}
            <path d="M10 24C10 22.3431 11.3431 21 13 21H35C36.6569 21 38 22.3431 38 24V31C38 32.6569 36.6569 34 35 34H13C11.3431 34 10 32.6569 10 31V24Z" fill="#075FC1" />
            {/* Wheels */}
            <rect x="13" y="32" width="6" height="4" rx="2" fill="#062B5C" />
            <rect x="29" y="32" width="6" height="4" rx="2" fill="#062B5C" />
            {/* Lights */}
            <circle cx="14" cy="27.5" r="2.5" fill="#FDE047" />
            <circle cx="34" cy="27.5" r="2.5" fill="#FDE047" />
            {/* Grill */}
            <rect x="20" y="27" width="8" height="2" rx="1" fill="#1296DB" opacity="0.8" />
          </svg>
        );
      case 'bike':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Wheels */}
            <circle cx="15" cy="30" r="7" stroke="#075FC1" strokeWidth="3" fill="none" />
            <circle cx="15" cy="30" r="3" fill="#062B5C" />
            <circle cx="33" cy="30" r="7" stroke="#075FC1" strokeWidth="3" fill="none" />
            <circle cx="33" cy="30" r="3" fill="#062B5C" />
            {/* Frame */}
            <path d="M15 30L23 20H31L33 30" stroke="#075FC1" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M23 20L20 13H17" stroke="#075FC1" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M23 20L15 30" stroke="#1296DB" strokeWidth="3" strokeLinecap="round" />
            {/* Engine / Tank */}
            <path d="M22 17C22 15.3431 23.3431 14 25 14H30C31.1046 14 32 14.8954 32 16V20H22V17Z" fill="#1296DB" />
            {/* Seat */}
            <path d="M17 19.5C17 18.6716 17.6716 18 18.5 18H22.5V21H17V19.5Z" fill="#062B5C" />
          </svg>
        );
      case 'health':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Heart background */}
            <path d="M24 39.5L21.4 37.1C12.2 28.8 6 23.2 6 16.2C6 10.6 10.4 6.2 16 6.2C19.2 6.2 22.2 7.7 24 10.1C25.8 7.7 28.8 6.2 32 6.2C37.6 6.2 42 10.6 42 16.2C42 23.2 35.8 28.8 26.6 37.1L24 39.5Z" fill="#075FC1" />
            {/* Plus Sign */}
      ...
      case 'term':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Canopy */}
            <path d="M24 10C14 10 9 17 8 23H40C39 17 34 10 24 10Z" fill="#075FC1" />
            {/* Umbrella Panels */}
            <path d="M24 10C20 14 19 20 18.5 23" stroke="#1296DB" strokeWidth="2.5" strokeLinecap="round" />
            <path d="M24 10C28 14 29 20 29.5 23" stroke="#1296DB" strokeWidth="2.5" strokeLinecap="round" />
            {/* Handle */}
            <path d="M24 23V34C24 35.6569 22.6569 37 21 37C19.3431 37 18 35.6569 18 34" stroke="#1296DB" strokeWidth="3" strokeLinecap="round" fill="none" />
            {/* Tip */}
            <path d="M24 10V7" stroke="#1296DB" strokeWidth="3" strokeLinecap="round" />
          </svg>
        );
      case 'investment':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Coin Circle */}
            <circle cx="24" cy="24" r="16" fill="#075FC1" />
            <circle cx="24" cy="24" r="12" stroke="#1296DB" strokeWidth="1.5" strokeDasharray="3 3" fill="none" />
            {/* Rupee Symbol */}
            ...
            {/* Sparkle Stars */}
            <path d="M38 12L39 15L42 16L39 17L38 20L37 17L34 16L37 15L38 12Z" fill="#1296DB" />
            <path d="M10 32L11 34L13 35L11 36L10 38L9 36L7 35L9 34L10 32Z" fill="#1296DB" />
          </svg>
        );
      case 'business':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Building */}
            <rect x="10" y="18" width="28" height="20" rx="3" fill="#075FC1" />
            {/* Awning */}
            <path d="M7 18C7 15.2386 9.23858 13 12 13H36C38.7614 13 41 15.2386 41 18V19H7V18Z" fill="#1296DB" />
            {/* Door */}
            <rect x="21" y="28" width="6" height="10" rx="1" fill="#062B5C" />
            {/* Windows */}
            <rect x="14" y="24" width="4" height="4" rx="1" fill="#1296DB" />
            <rect x="30" y="24" width="4" height="4" rx="1" fill="#1296DB" />
            {/* Small Sign */}
            <circle cx="24" cy="9" r="2" fill="#1296DB" />
            <line x1="24" y1="11" x2="24" y2="13" stroke="#1296DB" strokeWidth="2" />
          </svg>
        );
      case 'life':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Adult Person (Blue) */}
            <circle cx="20" cy="18" r="5" fill="#075FC1" />
            <path d="M12 34C12 28.4772 16.4772 24 22 24H23C25.7614 24 28 26.2386 28 29V34H12Z" fill="#075FC1" />
            {/* Child Person (Cyan) */}
            <circle cx="31" cy="22" r="4" fill="#1296DB" />
            <path d="M26 34C26 29.5817 29.5817 26 34 26H35C35.5523 26 36 26.4477 36 27V34H26Z" fill="#1296DB" />
          </svg>
        );
      case 'travel':
        return (
          <svg className="w-12 h-12 transition-transform duration-300" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Money Sack / Bag (Blue) */}
            <path d="M24 10C20 10 18 14 17 18C15 20 14 24 14 29C14 34.5 18.5 39 24 39C29.5 39 34 34.5 34 29C34 24 33 20 31 18C30 14 28 10 24 10Z" fill="#075FC1" />
            {/* Tie Bow (Cyan) */}
            <path d="M19 17C21.5 18 26.5 18 29 17L31 15C29 14.5 27 15 24 15.5C21 15 19 14.5 17 15L19 17Z" fill="#1296DB" />
            {/* Checkmark (White) */}
  ...
  return (
    <section 
      ref={heroRef} 
      className="relative overflow-hidden pt-28 pb-16 lg:pt-36 lg:pb-24 bg-[#F7FAFC] flex flex-col justify-center min-h-[92vh] w-full border-b border-slate-200/60"
    >
      {/* Ambient background glows in blue/cyan brand identity */}
      <div className="ambient-blob absolute top-[5%] left-[8%] w-[500px] h-[500px] bg-[#075FC1]/10 rounded-full blur-[110px] pointer-events-none z-0" />
      <div className="ambient-blob absolute bottom-[8%] right-[5%] w-[480px] h-[480px] bg-[#1296DB]/15 rounded-full blur-[130px] pointer-events-none z-0" />
      <div className="ambient-blob absolute top-[40%] left-[40%] w-[350px] h-[350px] bg-[#075FC1]/8 rounded-full blur-[90px] pointer-events-none z-0" />
            ...
            {HERO_CATEGORIES.map((cat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Text Label */}
                  <div className="text-center font-sans font-bold text-slate-700 text-[11px] md:text-[13px] leading-tight group-hover:text-[#075FC1] transition-colors duration-200">
        ...
        <div ref={statsRef} className="bg-white border border-slate-200/70 rounded-3xl p-6 shadow-xs max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {STATS.map((stat, idx) => (
            <div key={idx} className="space-y-1">
              <div className="font-display font-extrabold text-2xl md:text-3xl text-[#075FC1]">
