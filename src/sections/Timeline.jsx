  ...
  const steps = [
    {
      ...
      color: 'bg-[#2F6FAF] text-white border-[#2F6FAF]/20'
    },
    {
      num: '2',
      ...
      color: 'bg-[#67B7E8] text-white border-[#67B7E8]/20'
    },
    {
      num: '3',
      title: 'Buy Online',
    ...
    <section ref={containerRef} className="py-20 md:py-28 bg-white relative overflow-hidden border-b border-[#DCEAF4]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="absolute left-7 md:left-1/2 top-4 bottom-4 w-1 bg-[#DCEAF4] -translate-x-1/2 rounded-full" />
          
          {/* GSAP scroll-drawn progress indicator line */}
          <div
            className="absolute left-7 md:left-1/2 top-4 bottom-4 w-1 bg-gradient-to-b from-[#2F6FAF] via-[#67B7E8] to-[#67B7E8] -translate-x-1/2 rounded-full origin-top timeline-progress"
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 pl-16 md:pl-0 md:px-8">
                    <div className="timeline-card bg-white border border-[#DCEAF4] p-8 rounded-[32px] shadow-sm hover:shadow-md transition duration-300">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="text-xs font-extrabold text-[#2F6FAF] bg-[#EAF6FC] border border-[#2F6FAF]/20 rounded-lg px-2.5 py-0.5">
                          Step {step.num}
                        </span>
                      </div>
